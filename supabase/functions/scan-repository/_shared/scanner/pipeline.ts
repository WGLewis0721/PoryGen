...
import { sha256Hex, shortHash } from "../fingerprint.ts";
import { buildCycloneDxSbom } from "../sbom.ts";
import type { DependencyLicenseFinding, LicenseFileFinding, PolicyStatus } from "../types.ts";
import {
...
import { detectLanguage, lexicalNormalize } from "./lexicalNormalize.ts";
import type { LineRange, NormalizeFn, NormalizerId, ProbeFile, ProviderCoverage, SimilarityProvider } from "./providers/types.ts";
import { classifySimilarity, findSimilarities, type ProviderMatch, type SimilarityBand } from "./similarity.ts";
