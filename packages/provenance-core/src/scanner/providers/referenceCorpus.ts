...
import { REFERENCE_CORPUS, REFERENCE_CORPUS_VERSION } from "../corpus.js";
import { createStaticCorpusProvider } from "./staticCorpus.js";
import type { NormalizeFn, NormalizerId, SimilarityProvider } from "./types.js";
